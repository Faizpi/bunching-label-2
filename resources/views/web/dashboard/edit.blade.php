                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div id="label_length" class="form-group">
                            ...
                            <input type="number" name="length" class="form-control" value="{{$label->length}}" id="length" placeholder="Length">
                        </div>
                        <div class="form-group">
                            <label for="weight">Weight (Kg)</label>
                            <input type="number" name="weight" class="form-control" value="{{$label->weight}}" id="weight" placeholder="Weight">
                        </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div id="label_pitch" class="form-group">
                            ...
                            <div class="radio">
                                <label>
                                    <input name="pitch" value="20.25" type="radio" {{$label->pitch == 20.25 ? "checked":""}}> 20.25
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                        ...
                        <div class="form-group">                        
                            ...
                            <div class="radio">
                                <label>
                                    <input name="direction" value="S" type="radio" {{$label->direction == "S" ? "checked":""}}> S
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio">
                                <label>
                                    <input name="visual" value="OK" type="radio" {{$label->visual == "OK" ? "checked":""}}> OK
                                </label>
                            </div>
                            <div class="radio">
                                <label>
            ...
            <div class="col-sm-12 col-md-8 col-md-offset-2">
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <button id="save_and_print" type="button" class="btn btn-success btn-block">Save & Print</button>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <button id="just_save" type="button" class="btn btn-warning btn-block">Save</button>
                    </div>
                </div>
            </div>
        </div>
